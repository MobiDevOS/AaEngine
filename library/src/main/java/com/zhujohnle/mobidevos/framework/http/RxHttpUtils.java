...
import com.zhujohnle.mobidevos.framework.http.core.download.DownloadRetrofit;
import com.zhujohnle.mobidevos.framework.http.core.upload.UploadRetrofit;
...
/**
 * Created by zhujohnle on 2017/6/22.
 *
 * @author zhujohnle
 * 网络请求
 */
...
public class RxHttpUtils {
    ...
    public static HashSet<String> getCookie() {
        HashSet<String> preferences = (HashSet<String>) SPUtils.getInstance()
        .getStringSet(HttpEngineKeys.COOKIE, new HashSet<String>());
        return preferences;
    }
