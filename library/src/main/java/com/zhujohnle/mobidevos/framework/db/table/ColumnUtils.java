...
import com.zhujohnle.mobidevos.framework.db.annotation.Foreign;
import com.zhujohnle.mobidevos.framework.db.annotation.Id;
import com.zhujohnle.mobidevos.framework.db.annotation.NotNull;
import com.zhujohnle.mobidevos.framework.db.annotation.Transient;
import com.zhujohnle.mobidevos.framework.db.annotation.Unique;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(TableForeign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(TableFinder finderColumn) {
