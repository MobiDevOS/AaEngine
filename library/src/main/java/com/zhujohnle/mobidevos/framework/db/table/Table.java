...
public class Table {
     ...
     * key: columnName
     */
    public final HashMap<String, TableColumn> columnMap;

    /**
     * key: columnName
     */
    public final HashMap<String, TableFinder> finderMap;
    ...
    private Table(DbTools db, Class<?> entityType) {
        ...
        finderMap = new HashMap<String, TableFinder>();
        for (TableColumn column : columnMap.values()) {
            column.setTable(this);
            if (column instanceof TableFinder) {
                finderMap.put(column.getColumnName(), (TableFinder) column);
            }
        }
    }
